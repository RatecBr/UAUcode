...
export default function Login() {
  ...
  const styles = {
    ...
    bgGlow: {
      ...
      height: "400px",
      background:
        "radial-gradient(circle, rgba(188, 54, 194, 0.2) 0%, transparent 70%)",
      borderRadius: "50%",
    ...
    logo: {
      ...
      fontWeight: 800,
      background:
        "linear-gradient(135deg, var(--neon-blue) 0%, var(--neon-purple) 50%, var(--neon-red) 100%)",
  ...
  return (
    <div style={styles.container}>
      ...
      <button
        ...
        onMouseEnter={(e) =>
          (e.currentTarget.style.backgroundColor = "rgba(188, 54, 194, 0.1)")
        }
        onMouseLeave={(e) =>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.inputGroup}>
            ...
            <input
              type="password"
              placeholder={
                mode === "signup" ? "Senha (mín. 6 caracteres)" : "Sua senha"
              }
              value={password}
